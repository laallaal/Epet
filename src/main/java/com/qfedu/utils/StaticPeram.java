...
public class StaticPeram {
    ...
    final static String accessKeyId = "LTAI4FqPovCViX7DHSgkECAA";// 你的accessKeyId,填你自己的 上文配置所得  自行配置

    final static String accessKeySecret = "2L44D92ryr9jLd5TWoc4DezdCAF1yU";// 你的accessKeySecret,填你自己的 上文配置所得 自行配置

    // 必填:短信签名-可在短信控制台中找到

    final static String SignName = "E宠验证码";    // 阿里云配置你自己的短信签名填入

    // 必填:短信模板-可在短信控制台中找到

    final static String TemplateCode = "SMS_175060675"; // 阿里云配置你自己的短信模板填入
